  ...
  return (
    <div className="container mx-auto mt-10 px-3">
      <h1 className="text-3xl font-semibold text-primary text-center">
        Gurudev Rice Privacy Policy
      </h1>
      <div className=" py-6">
        <h2 className="text-lg font-medium py-3">Effective date: 2022-11-14</h2>
        Welcome to Guru Dev Rice. Guru Dev Rice (“us”, “we”, or “our”) operates
        gurudevrice.com (hereinafter referred to as “Service”).
        <br />
        Our Privacy Policy governs your visit to gurudevrice.com, and explains
        ...
        SERVICE means the gurudevrice.com website operated by Guru Dev Rice
        <br />
        ...
        <br />
        <h2 className="text-lg font-medium py-3">Types of Data Collected</h2>
        ...
        other diagnostic data. Tracking Cookies Data We use cookies and similar
        tracking technologies to track the activity on our Service and we hold
        ...
        able to use some portions of our Service. Examples of Cookies we use:
        ...
        advertisements that may be relevant to you and your interests. <br />
        ...
        <h2 className="text-lg font-medium py-3">Use of Data</h2>
        Guru Dev Rice uses the collected data for various purposes: 0.1. to
        ...
        <br /> collection; 0.10. to provide you with notices about your account
        ...
        <br /> to those that you have already purchased or enquired about unless
        you have opted not to receive such information; 0.12. in any other way
        we may describe when you provide the information; <br />
        0.13. for any other purpose with your consent. <br />
        <h2 className="text-lg font-medium py-3">Retention of Data</h2>
        ...
        <br />
        <h2 className="text-lg font-medium py-3">Transfer of Data</h2>
        ...
        of such information represents your agreement to that transfer. Guru Dev
        Rice will take all the steps reasonably necessary to ensure that your
        data is treated securely and in accordance with this Privacy Policy and
        no transfer of your Personal Data will take place to an organisation or
        a country unless there are adequate controls in place including the
        security of your data and other personal information.
        <h2 className="text-lg font-medium py-3">Disclosure of Data</h2>
        We may disclose personal information that we collect, or you provide:
        0.1. Business Transaction. <br />
        If we or our subsidiaries are involved in a merger, acquisition or asset
        sale, your Personal Data may be transferred. 0.2. Other cases. We may
        disclose your information also: <br />
        ...
        the rights, property, or safety of the Company, our customers, or <br />{" "}
        others.
        <h2 className="text-lg font-medium py-3">Security of Data</h2>
        ...
        our systems, please email us at support@gurudevrice.com. In certain
        ...
        <br /> commonly used format; 0.6. the right to withdraw consent. You
        also have the right to withdraw your consent at any time where we rely
        on your consent to process your <br /> personal information; Please note
        ...
        information by emailing us at support@gurudevrice.com. Our Policy on “Do
        ...
        support@gurudevrice.com. Your data protection rights, described above,
        ...
        <h2 className="text-lg font-medium py-3">20. Contact Us</h2>
        If you have any questions about this Privacy Policy, please contact us
        by email: support@gurudevrice.com.
      </div>
    </div>
  );
};
